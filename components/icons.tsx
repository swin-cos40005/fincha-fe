  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.22986 2.75647C8.17737 2.5854 8.04542 2.456 7.86873 2.41691C7.69203 2.37782 7.50641 2.43855 7.38288 2.57288L1.38288 9.07288C1.23759 9.22959 1.23759 9.47041 1.38288 9.62712L7.38288 16.1271C7.50641 16.2615 7.69203 16.3222 7.86873 16.2831C8.04542 16.244 8.17737 16.1146 8.22986 15.9435L9.72986 10.6935C9.771 10.5574 9.745 10.408 9.66 10.295C9.575 10.182 9.44 10.125 9.3 10.125H7.125V6.375H9.3C9.44 6.375 9.575 6.318 9.66 6.205C9.745 6.092 9.771 5.9426 9.72986 5.8065L8.22986 2.75647ZM8 0.75C8.75736 0.75 9.42157 1.25736 9.64525 2.01352L11.1453 7.26352C11.271 7.66578 11.1803 8.10422 10.91 8.43C10.6397 8.75578 10.2235 8.925 9.8 8.925H8.625V13.575C8.625 14.1273 8.17228 14.58 7.62 14.58C7.06772 14.58 6.615 14.1273 6.615 13.575V8.925H5.44C5.0165 8.925 4.60032 8.75578 4.33 8.43C4.05968 8.10422 3.969 7.66578 4.09475 7.26352L5.59475 2.01352C5.81843 1.25736 6.48264 0.75 7.24 0.75H8Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const TableIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2 2.5C2 2.22386 2.22386 2 2.5 2H13.5C13.7761 2 14 2.22386 14 2.5V13.5C14 13.7761 13.7761 14 13.5 14H2.5C2.22386 14 2 13.7761 2 13.5V2.5ZM3.5 3.5V5.5H5.5V3.5H3.5ZM7 3.5V5.5H9V3.5H7ZM10.5 3.5V5.5H12.5V3.5H10.5ZM12.5 7V9H10.5V7H12.5ZM9 7V9H7V7H9ZM5.5 7V9H3.5V7H5.5ZM3.5 10.5V12.5H5.5V10.5H3.5ZM7 10.5V12.5H9V10.5H7ZM10.5 10.5V12.5H12.5V10.5H10.5Z"
      fill="currentColor"
    />
  </svg>
);

export const ChartBarIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M1.5 2.5V13.5H14.5V15H0V2.5H1.5ZM4 11.5V6.5H6V11.5H4ZM7.5 11.5V4.5H9.5V11.5H7.5ZM11 11.5V8.5H13V11.5H11Z"
      fill="currentColor"
    />
  </svg>
);
...
export const PieChartIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8 0.5C12.1421 0.5 15.5 3.85786 15.5 8C15.5 12.1421 12.1421 15.5 8 15.5C3.85786 15.5 0.5 12.1421 0.5 8C0.5 3.85786 3.85786 0.5 8 0.5ZM8 2V8H14C14 4.13401 10.866 2 8 2ZM8 14C11.3137 14 14 11.3137 14 8H8V2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z"
      fill="currentColor"
    />
  </svg>
);
...
export const SearchIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.5 7C11.5 9.48528 9.48528 11.5 7 11.5C4.51472 11.5 2.5 9.48528 2.5 7C2.5 4.51472 4.51472 2.5 7 2.5C9.48528 2.5 11.5 4.51472 11.5 7ZM10.7071 10.7071L13.8536 13.8536L13.1464 14.5607L10 11.4142C9.16519 11.7528 8.2315 12 7.25 12C4.90279 12 3 10.0972 3 7.75C3 5.40279 4.90279 3.5 7.25 3.5C9.59721 3.5 11.5 5.40279 11.5 7.75C11.5 8.7315 11.2528 9.66519 10.9142 10.5L10.7071 10.7071ZM4 7.75C4 9.54493 5.45507 11 7.25 11C9.04493 11 10.5 9.54493 10.5 7.75C10.5 5.95507 9.04493 4.5 7.25 4.5C5.45507 4.5 4 5.95507 4 7.75Z"
      fill="currentColor"
    />
  </svg>
);
...
export const FilterIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2 3.5H14V4.5H2V3.5ZM4 7.5H12V8.5H4V7.5ZM10 11.5H6V12.5H10V11.5Z"
      fill="currentColor"
    />
  </svg>
);
export const ReloadIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8 1.5C4.96243 1.5 2.5 3.96243 2.5 7C2.5 10.0376 4.96243 12.5 8 12.5C11.0376 12.5 13.5 10.0376 13.5 7H12.5C12.5 9.48528 10.4853 11.5 8 11.5C5.51472 11.5 3.5 9.48528 3.5 7C3.5 4.51472 5.51472 2.5 8 2.5C9.39219 2.5 10.6146 3.15311 11.3536 4.14645L10 5.5H14V1.5L12.6464 2.85355C11.6131 1.56689 9.90781 0.5 8 0.5C4.41015 0.5 1.5 3.41015 1.5 7C1.5 10.5899 4.41015 13.5 8 13.5C11.5899 13.5 14.5 10.5899 14.5 7H13.5C13.5 10.0376 11.0376 12.5 8 12.5Z"
      fill="currentColor"
    />
  </svg>
);

export const MissingIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0ZM1.5 8C1.5 4.41015 4.41015 1.5 8 1.5C11.5899 1.5 14.5 4.41015 14.5 8C14.5 11.5899 11.5899 14.5 8 14.5C4.41015 14.5 1.5 11.5899 1.5 8ZM8 4C8.41421 4 8.75 4.33579 8.75 4.75V7.25C8.75 7.66421 8.41421 8 8 8C7.58579 8 7.25 7.66421 7.25 7.25V4.75C7.25 4.33579 7.58579 4 8 4ZM8 10.5C8.55228 10.5 9 10.9477 9 11.5C9 12.0523 8.55228 12.5 8 12.5C7.44772 12.5 7 12.0523 7 11.5C7 10.9477 7.44772 10.5 8 10.5Z"
      fill="currentColor"
    />
  </svg>
);
...
export const PostgresIcon = ({ size = 16 }: { size?: number }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size * 0.88} 
  ...
  >
    ...
    <g fill="none" stroke="#fff" strokeWidth="1.682">
      <g strokeLinecap="round">
        <path d="M53.06 44.562c-.187 6.682.047 13.4.7 15.046s2.054 4.816 6.87 3.785c4.022-.862 5.486-2.53 6.12-6.214.468-2.7 1.37-10.236 1.485-11.778M47.3 11.063s-21.797-8.9-20.783 11.35c.216 4.3 6.178 32.613 13.3 24.064 2.6-3.126 4.95-5.578 4.95-5.578M59.064 9.437c-.755.237 12.125-4.708 19.444 4.644 2.585 3.304-.4 16.804-7.578 27.44" strokeLinejoin="round"/>
        <path d="M70.93 41.52s.467 2.3 7.255.898c2.974-.614 1.184 1.724-1.832 3.125-2.476 1.15-8.026 1.443-8.117-.144-.234-4.096 2.92-2.852 2.694-3.878-.206-.924-1.617-1.832-2.55-4.094-.815-1.975-11.173-17.12 2.873-14.87.515-.106-3.663-13.36-16.808-13.575s-12.7 16.162-12.7 16.162" strokeLinejoin="bevel"/>
      </g>
      <g strokeLinejoin="round">
        ...
        <path d="M49.262 42.886c-.184-1.203.396-2.635 1.017-4.31.934-2.513 3.09-5.028 1.365-13-1.285-5.942-9.904-1.237-9.91-.43s.4 4.084-.144 7.9c-.697 4.98 3.17 9.194 7.622 8.763" strokeLinecap="round"/>
      </g>
    </g>
    <g fill="#fff" stroke="#fff" strokeWidth="1.682">
      <path d="M47.212 25.023c-.04.275.504 1.01 1.21 1.108s1.31-.475 1.35-.75-.504-.578-1.21-.677-1.312.045-1.35.32z" strokeWidth=".561"/>
      <path d="M68.725 24.462c.038.275-.504 1-1.21 1.108s-1.31-.475-1.35-.75.505-.578 1.212-.677 1.31.045 1.35.32z" strokeWidth=".28"/>
    </g>
    <path d="M71.253 22.557c.116 2.158-.465 3.63-.538 5.927-.11 3.34 1.592 7.162-.97 10.99" fill="none" stroke="#fff" strokeWidth="1.682" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const NormalizerIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    width={size}
    viewBox="0 0 49 42"
  ...
  >
    <g transform="translate(0.000000,42.000000) scale(0.100000,-0.100000)">
      <path d="M160 287 c0 -9 -7 -17 -15 -17 -8 0 -15 -4 -15 -10 0 -5 7 -10 15 -10 8 0 15 -8 15 -17 0 -15 3 -14 22 5 l22 22 -22 22 c-19 19 -22 20 -22 5z"/>
      <path d="M316 281 c-20 -22 -20 -22 2 -44 19 -18 22 -19 22 -4 0 9 7 17 15 17 8 0 15 5 15 10 0 6 -6 10 -14 10 -8 0 -16 7 -18 16 -2 14 -6 13 -22 -5z"/>
      <path d="M170 180 c0 -23 -10 -26 -28 -8 -9 9 -12 6 -12 -14 0 -21 4 -25 20 -21 15 4 20 0 20 -16 0 -11 5 -21 10 -21 6 0 10 8 10 19 0 16 8 19 60 19 52 0 60 -3 60 -19 0 -11 5 -19 10 -19 6 0 10 10 10 21 0 16 5 20 20 16 16 -4 20 0 20 21 0 20 -3 23 -12 14 -18 -18 -28 -15 -28 8 0 11 -4 20 -10 20 -5 0 -10 -8 -10 -18 0 -16 -9 -18 -60 -18 -51 0 -60 2 -60 18 0 10 -4 18 -10 18 -5 0 -10 -9 -10 -20z"/>
    </g>
  </svg>
);